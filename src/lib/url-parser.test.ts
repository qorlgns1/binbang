...
describe('parseAccommodationUrl', () => {
  describe('Airbnb URL', () => {
    it('전체 파라미터 파싱 (check_in, check_out, adults, room ID)', () => {
  ...
  describe('Agoda URL', () => {
    it('전체 파라미터 파싱 (checkIn, los, adults, 호텔명)', () => {
      const url =
    ...
    it('kebab-case 호텔명을 Title Case로 변환', () => {
    ...
    it('checkIn만 있고 los 없으면 checkOut null', () => {

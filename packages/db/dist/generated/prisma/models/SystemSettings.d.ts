...
export type GetSystemSettingsAggregateType<T extends SystemSettingsAggregateArgs> = {
    [P in keyof T & keyof AggregateSystemSettings]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateSystemSettings[P]> : Prisma.GetScalarType<T[P], AggregateSystemSettings[P]>;
};
...
type GetSystemSettingsGroupByPayload<T extends SystemSettingsGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<SystemSettingsGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof SystemSettingsGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], SystemSettingsGroupByOutputType[P]> : Prisma.GetScalarType<T[P], SystemSettingsGroupByOutputType[P]>;
}>>;
export type SystemSettingsWhereInput = {
    ...
    category?: Prisma.StringFilter<"SystemSettings"> | string;
...
export type SystemSettingsScalarWhereWithAggregatesInput = {
    ...
    category?: Prisma.StringWithAggregatesFilter<"SystemSettings"> | string;
...
export type SystemSettingsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value" | "type" | "category" | "description" | "updatedAt", ExtArgs["result"]["systemSettings"]>;
...
export type SystemSettingsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<SystemSettingsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SystemSettingsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const systemSettingsWithKeyOnly = await prisma.systemSettings.updateManyAndReturn({
     *   select: { key: true },
     *   where: {
     *     // ... provide filter here
     *   },
     ...
     * })
    **/
    count<T extends SystemSettingsCountArgs>(args?: Prisma.Subset<T, SystemSettingsCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], SystemSettingsCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends SystemSettingsGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, SystemSettingsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSystemSettingsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface SystemSettingsFieldRefs {
    ...
    readonly category: Prisma.FieldRef<"SystemSettings", 'String'>;

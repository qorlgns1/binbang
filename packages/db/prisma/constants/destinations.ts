...
export const SEED_DESTINATIONS: SeedDestination[] = [
  ...
  },
  {
    ...
    highlightsKo: ['도톤보리 먹자골목 음식 투어', '오사카성 역사 탐방', '구로몬 시장 해산물 맛집', '유니버설 스튜디오 재팬', '신사이바시 쇼핑 거리'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['금각사(킨카쿠지) 황금 정원', '후시미 이나리 신사 천개의 도리이', '아라시야마 대나무 숲', '기온 게이샤 거리 산책', '기요미즈데라 사원 전망대'],
    highlightsEn: [
  ...
  // ── 한국 ──
  {
    ...
    highlightsKo: ['경복궁과 광화문 광장', '명동 쇼핑과 길거리 음식', '북촌 한옥마을 전통 체험', '남산 N서울타워 야경', '홍대와 강남 나이트라이프'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['해운대 해수욕장과 달맞이길', '자갈치 시장 활어회', '감천문화마을 골목 투어', '해동용궁사 일출 감상', '광안리 해변과 광안대교 야경'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['한라산 등반과 백록담', '성산일출봉 일출 감상', '협재 해수욕장 에메랄드빛 바다', '만장굴 용암동굴 탐험', '제주 흑돼지와 해산물 맛집'],
    highlightsEn: [
  ...
  // ── 태국 ──
  {
    ...
    highlightsKo: ['왓 프라깨우(에메랄드 사원)와 왕궁', '왓 아룬(새벽의 사원) 야경', '카오산 로드 백패커 거리', '차오프라야 강 디너 크루즈', '짜뚜짝 주말 시장 쇼핑'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['파통 비치 해양 스포츠', '피피 섬 당일 투어', '빅 부처상과 전망대', '푸켓 판타지 쇼', '방라 로드 나이트라이프'],
    highlightsEn: ['Patong Beach water sports', 'Phi Phi Islands day trip', 'Big Buddha and viewpoint', 'Phuket FantaSea show', 'Bangla Road nightlife'],
  },
  {
    slug: 'chiang-mai',
    nameKo: '치앙마이',
    ...
    highlightsKo: ['왓 프라탓 도이수텝 황금 사원', '코끼리 보호센터 체험', '도이 인타논 국립공원 트레킹', '나이트 바자 쇼핑', '란나 전통 마사지'],
    highlightsEn: [
  ...
  // ── 프랑스 ──
  {
    ...
    highlightsKo: ['에펠탑 정상 전망대', '루브르 박물관 모나리자', '샹젤리제 거리와 개선문', '몽마르트 언덕과 사크레쾨르', '센 강 유람선 투어'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['프롬나드 데 장글레 해변 산책', '구시가지 쿠르 살레야 시장', '샤갈 미술관', '성 언덕(Colline du Château) 전망', '지중해 해산물 요리'],
    highlightsEn: [
  ...
  // ── 이탈리아 ──
  {
    ...
    highlightsKo: ['콜로세움과 고대 로마 유적', '바티칸 시스티나 성당 천장화', '트레비 분수 동전 던지기', '스페인 계단과 젤라또', '판테온과 나보나 광장'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['곤돌라 타고 대운하 투어', '산 마르코 대성당과 광장', '리알토 다리와 시장', '무라노 섬 유리 공예 구경', '부라노 섬 알록달록한 집들'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['미켈란젤로 다비드상 감상', '우피치 미술관 르네상스 걸작', '두오모 성당 쿠폴라 전망', '베키오 다리와 아르노 강', '토스카나 와인과 비스테카'],
    highlightsEn: [
  ...
  // ── 영국 ──
  {
    ...
    highlightsKo: ['버킹엄 궁전 근위병 교대식', '대영박물관 무료 입장', '빅벤과 웨스트민스터 사원', '런던아이 템스 강 전망', '코벤트 가든과 애프터눈 티'],
    highlightsEn: [
  ...
  // ── 스페인 ──
  {
    ...
    highlightsKo: ['사그라다 파밀리아 성당', '구엘 공원 모자이크 테라스', '람블라스 거리와 보케리아 시장', '고딕 지구 역사 탐방', '바르셀로네타 해변과 파에야'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['프라도 미술관 명화 감상', '레티로 공원 보트 타기', '왕궁과 알무데나 대성당', '그랑 비아 쇼핑 거리', '타파스 바 호핑과 플라멩코'],
    highlightsEn: [
  ...
  // ── 미국 ──
  {
    ...
    highlightsKo: ['자유의 여신상 페리 투어', '타임스퀘어와 브로드웨이 뮤지컬', '센트럴 파크 산책', '메트로폴리탄 미술관', '브루클린 브릿지 야경'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['할리우드 명예의 거리', '유니버설 스튜디오', '산타모니카 피어와 해변', '그리피스 천문대 야경', '베벌리힐스 로데오 드라이브'],
    highlightsEn: [
  ...
  },
  {
    ...
    highlightsKo: ['금문교 전망대', '케이블카 투어', '피셔맨스 워프 크램 차우더', '알카트라즈 섬 감옥 투어', '롬바드 스트리트 구불길'],
    highlightsEn: [
  ...
  // ── 싱가포르 ──
  {
    ...
    highlightsKo: ['마리나 베이 샌즈 인피니티 풀', '가든스 바이 더 베이 슈퍼트리', '센토사 섬 리조트', '차이나타운과 리틀 인디아', '호커 센터 다국적 음식'],
    highlightsEn: [
  ...
  // ── 호주 ──
  {
    ...
    highlightsKo: ['시드니 오페라 하우스 투어', '하버 브리지 클라이밍', '본다이 비치 서핑', '달링 하버 야경', '블루 마운틴 국립공원'],
    highlightsEn: ['Sydney Opera House tour', 'Harbour Bridge climb', 'Bondi Beach surfing', 'Darling Harbour night view', 'Blue Mountains National Park'],
  },
  {
    slug: 'melbourne',
    nameKo: '멜버른',
    ...
    highlightsKo: ['연방 광장과 플린더스 역', '퀸 빅토리아 마켓', '골목길 스트리트 아트 투어', '그레이트 오션 로드', '멜버른 카페 문화 체험'],
    highlightsEn: [
  ...
  // ── 뉴질랜드 ──
  {
    ...
    highlightsKo: ['스카이 타워 전망대', '와이헤케 섬 와이너리', '와이토모 반딧불이 동굴', '마오리 문화 공연', '미션 베이 해변'],
    highlightsEn: ['Sky Tower observation deck', 'Waiheke Island wineries', 'Waitomo Glowworm Caves', 'Maori cultural performance', 'Mission Bay beach'],
  },
  // ── 베트남 ──
  {
    slug: 'hanoi',
    ...
    highlightsKo: ['호안끼엠 호수와 옥산 사원', '구시가지 36거리', '호치민 묘소', '하롱베이 크루즈', '분짜와 에그 커피'],
    highlightsEn: ['Hoan Kiem Lake and Ngoc Son Temple', 'Old Quarter 36 Streets', 'Ho Chi Minh Mausoleum', 'Halong Bay cruise', 'Bun cha and egg coffee'],
  },
  {
    slug: 'ho-chi-minh',
    nameKo: '호치민',
    ...
    highlightsKo: ['노트르담 대성당과 중앙 우체국', '전쟁 박물관', '벤탄 시장 쇼핑', '메콩 델타 보트 투어', '반미와 분보 훼'],
    highlightsEn: [
  ...
  // ── 말레이시아 ──
  {
    ...
    highlightsKo: ['페트로나스 트윈 타워 야경', '바투 동굴 힌두 사원', '부킷 빈탕 쇼핑 거리', '메르데카 광장', '말레이시아 다국적 음식'],
    highlightsEn: [
  ...
  // ── 인도네시아 ──
  {
    ...
    highlightsKo: ['우붓 계단식 논과 원숭이 숲', '울루와뚜 사원 일몰', '탄중 베노아 해양 스포츠', '스미냑 비치 클럽', '발리 전통 마사지'],
    highlightsEn: [
  ...
  // ── UAE ──
  {
    ...
    highlightsKo: ['부르즈 칼리파 전망대', '두바이 몰과 분수 쇼', '사막 사파리와 낙타 타기', '골드 수크 시장', '팜 주메이라 리조트'],
    highlightsEn: ['Burj Khalifa observation deck', 'Dubai Mall and fountain show', 'Desert safari and camel riding', 'Gold Souk market', 'Palm Jumeirah resorts'],
  },
  // ── 터키 ──
  {
    slug: 'istanbul',
    ...
    highlightsKo: ['블루 모스크와 아야 소피아', '그랜드 바자르 쇼핑', '보스포루스 크루즈', '톱카프 궁전', '터키식 목욕탕 하맘'],
    highlightsEn: ['Blue Mosque and Hagia Sophia', 'Grand Bazaar shopping', 'Bosphorus cruise', 'Topkapi Palace', 'Turkish bath hammam'],
  },
];

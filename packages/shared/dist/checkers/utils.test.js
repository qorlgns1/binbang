...
import { calculateNights, formatDate, isRetryableError } from './utils';
describe('isRetryableError', () => {
    ...
    it('Runtime.callFunctionOn timed out → 재시도 불가 (페이지 JS 런타임 멈춤)', () => {
        expect(isRetryableError("Runtime.callFunctionOn timed out. Increase the 'protocolTimeout' setting in launch/connect calls for a higher timeout if needed.")).toBe(false);
    });

 ...
 * 카카오톡 나에게 보내기
 */
export async function sendKakaoMessage({ userId, title, description, buttonText = '확인하기', buttonUrl = '' }, retried = false) {
    ...
    try {
        ...
        const response = await axios.post('https://kapi.kakao.com/v2/api/talk/memo/default/send', new URLSearchParams({
 ...
 * 숙소 예약 가능 알림 보내기
 */
export async function notifyAvailable(userId, accommodationName, checkIn, checkOut, price, checkUrl) {

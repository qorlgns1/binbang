      ...
      <div className='prose prose-neutral mt-8 dark:prose-invert'>
        ...
        <section className='mt-8'>
          ...
          <p className='mt-2 text-muted-foreground'>
            회원가입 또는 서비스 이용 시 본 약관에 동의한 것으로 간주됩니다. 약관은 필요에 따라 변경될 수 있으며, 변경
            시 사전에 공지합니다.
          </p>
        </section>
        ...
        <section className='mt-6'>
          ...
          <p className='mt-2 text-muted-foreground'>
            서비스는 관련 법령과 본 약관을 준수하여 이용해 주시기 바랍니다. 타인의 계정을 사용하거나, 서비스의 정상적인
            운영을 방해하는 행위는 금지됩니다.
          </p>
        </section>
        <section className='mt-6'>
          ...
          <p className='mt-2 text-muted-foreground'>
            예약 사이트의 구조 변경이나 장애로 인해 알림이 지연되거나 누락될 수 있습니다. 최종적인 예약 가능 여부는 해당
            예약 사이트에서 직접 확인하시기 바랍니다. 이러한 사유로 인한 불이익에 대해서는 책임을 지지 않습니다.
          </p>
        </section>
        <section className='mt-6'>

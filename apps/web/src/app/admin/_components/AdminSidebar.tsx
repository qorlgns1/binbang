...
const NAV_GROUPS: Array<{
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/awin', label: 'Awin API 테스트', icon: Link2 },
      { href: '/admin/agoda', label: 'Agoda API 테스트', icon: Hotel },
      { href: '/admin/affiliate-advertisers', label: '가입 광고주 관리', icon: Building2 },
